...
int pop(int[], int&, int = -1);
long long pop(long long[], int&, int = -1);
float pop(float[], int&, int = -1);
double pop(double[], int&, int = -1);
int pop(int[], long long&, long long = -1);
long long pop(long long[], long long&, long long = -1);
float pop(float[], long long&, long long = -1);
double pop(double[], long long&, long long = -1);
